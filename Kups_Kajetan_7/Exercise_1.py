...
if __name__ == "__main__":
    ...
    H_img_1 = calculate_H(img_1, sobel_size=15, gauss_filter_mask_size=5)
    H_img_2 = calculate_H(img_2, sobel_size=15, gauss_filter_mask_size=5)

    threshold_value_1 = 180  # Threshold value between 0 and 255
    _, H_img_1 = cv2.threshold(H_img_1, threshold_value_1, 255, cv2.THRESH_BINARY)
    threshold_value_2 = 133  # Threshold value between 0 and 255
